...
export class SimpleBmxFormData extends AbstractBmxFormData {
	...
	public static readonly DEFAULT_FORM_SUBMIT: BmxSubmitButton = {
		...
		onSubmit: (formGroup: UntypedFormGroup) => console.error('BmxSubmitButton#onSubmit is not implemented!'),
		validateBeforeSubmit: true
	};

	public static readonly DEFAULT_BUTTON: BmxFormButton = {
		title: 'submit',
		onSubmit: (formGroup: UntypedFormGroup) => console.error('BmxFormButton#onSubmit is not implemented!'),
